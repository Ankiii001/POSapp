...
isHidden: boolean
  ...
  constructor(private customerService: CustomersService,private router: Router, private route: ActivatedRoute, private cartService: CartService, private toastr: ToastrService) { }
  ...
  clearCart() {
    this.cartService.clearCart(this.cart.id).subscribe(data => {
      this.cart = {};
      this.subtotal = 0.00;
    })
  }
  ...
  deleteProductFromCart(productId) {
    this.cartService.deleteProductFromCart(this.cart.id, productId).subscribe(data => {
