...
export class OrderService {
  private ORDER_URL = "http://localhost:8080/pos_application/api/orders";
  private EMPLOYEES_URL = "http://localhost:8080/pos_application/api/employees/";
  private CUSTOMER_URL = "http://localhost:8080/pos_application/api/customers/";
